...
static void applyApplicationStyle(QApplication &app)
{
    ...
    app.setStyleSheet(QStringLiteral(R"STYLE(
        ...
        QFrame#contentCard { background: #ffffff; border: 1px solid #dfe6f0; border-radius: 12px; }
        ...
        QPushButton#navigationButton { text-align: left; padding: 11px 15px; min-height: 32px; font-weight: 600; }
